...
public class LayoutParams {
    ...
    public static void setWidthHeightAndMargin(View view, int width, int height, int top, int bottom, int left, int right) {
    ...
    public static void setParamMargin(View view, int top, int bottom, int left, int right) {
        FrameLayout.LayoutParams layoutParams = null;
        layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
        if (layoutParams == null) {
            layoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    public static void setParamWidthHeight(View view, int width, int height) {
        FrameLayout.LayoutParams layoutParams = null;
        layoutParams = (FrameLayout.LayoutParams) view.getLayoutParams();
        if (layoutParams == null) {
            layoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
    ...
    public static int getNavBarHeight(Activity mActivity) {
